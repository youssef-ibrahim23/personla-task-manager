      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizationsHelper(context).appTitle,
              textAlign: TextAlign.center,
              style: TextStyle(color: AppColors.primary , fontSize: 60, fontFamily: 'Luckiest Guy'),
            ).animate().shimmer(
          duration: 1.seconds,
          color: AppColors.light,
        ),
            Spacer(),
            Image.asset("assets/images.jpeg").animate().move(begin: const Offset(0, 50), duration: 700.ms),
          ],
        ),
      ),
    );
